...
<%
		...
		if(count==0)
                ...
                st.executeUpdate("insert into admnregistration(username,secretquestion,answer,name,designation,officialaddress,phonen,residentialaddress,pincode,phone,email) values('" + user + "','"+se+"', '" + an + "','" + na + "','" + de + "','" + add + "'," + phone + ",'" + adr + "'," + pin + "," + phone1 + ",'" + email + "')");
                out.println("Successfully Data submitted");
		}
		else out.println("Admin already found !!");
